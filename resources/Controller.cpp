...
/**
*Gets actual speed of the left motor
*/
...
/**
*Gets actual speed of the right motor
*/
...
void Controller::run() {
    ...
    while (true) {
        ...
        short dnLeft = desiredSpeedLeft-actualSpeedLeft;
        short dnRight = desiredSpeedRight-actualSpeedRight;

        float voltageLeft = KP*dnLeft+desiredSpeedLeft/KN;
        float voltageRight = KP*dnRight+desiredSpeedRight/KN;
